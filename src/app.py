...
activities = {
    ...
    "Tennis Club": {
        "description": "Learn and practice tennis skills with competitive matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["alex@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Join our competitive basketball team for training and games",
    ...
    "Science Club": {
        ...
        "max_participants": 20,
        "participants": ["avery@mergington.edu", "parker@mergington.edu"]
    }
}
